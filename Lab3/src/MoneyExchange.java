...
Scanner scanner = new Scanner(System.in);
      ...
      double gbp = Utils.getInt("Enter amount in GBP: ");

       
        int currencyChoice = Utils.getInt("Choose currency (1 = USD, 2 = EUR, 3 = JPY): ");

        System.out.print("Enter customer type (R = Regular, V = VIP, S = Staff): ");
       
        char customerType = Utils.getString("Enter customer type (R = Regular, V = VIP, S = Staff): ").toUpperCase().charAt(0);
